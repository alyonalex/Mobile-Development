package ru.mirea.krasikovaaa.httpurlconnection;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvCity, tvRegion, tvCountry, tvLatitude, tvLongitude;
    private TextView tvTemperature, tvWindspeed, tvWinddirection;
    ...
    private class DownloadWeatherTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            tvStatus.setText("Загружаем информацию о погоде...");
            tvTemperature.setText("Температура: ");
            tvWindspeed.setText("Скорость ветра: ");
            tvWinddirection.setText("Направление ветра: ");
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (json.has("current_weather")) {
                    ...
                    tvStatus.setText("Данные получены");
                } else {
